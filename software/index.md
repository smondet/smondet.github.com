...
- [Sosa](./sosa/index.html): The “Sane OCaml String API” library is a set of APIs (module types) that define what a string of characters should be, and a set of modules and functors that implement them (see on [Github](https://github.com/smondet/sosa)).
...
- [Ketrew](./ketrew/index.html): Workflow Engine for complex computational experiments (see on [Github](https://github.com/hammerlab/ketrew), and also the documentation for versions:  [`pbs_backend`](ketrew/pbs_backend/index.html), [`long_running_factorization`](ketrew/long_running_factorization/index.html)).
