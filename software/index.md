...
- [Ketrew](./ketrew/index.html): Workflow Engine for complex computational experiments (see on [Github](https://github.com/hammerlab/ketrew), and also the documentation for [version 0.0.0](ketrew/doc.0.0.0/index.html), [version 1.0.0](ketrew/doc.1.0.0/index.html), [version 1.1.0](ketrew/doc.1.1.0/index.html), [version 1.1.1](ketrew/doc.1.1.1/index.html), and for [version 2.0.0](ketrew/doc.2.0.0/index.html)).
...
- [Trakeva](./trakeva/index.html): Transactions, Keys, and Values: an API describing key-value storage with ACID transactions *and* different backends (see on [Github](https://github.com/smondet/trakeva), and also the documentation for [version 0.0.0](trakeva/trakeva.0.0.0/index.html) and for [version 0.1.0](trakeva/trakeva.0.1.0/index.html)).
